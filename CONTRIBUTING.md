# Contributing to quick-windows

First and foremost, thank you! We appreciate that you want to contribute to quick-windows, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for quick-windows**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for quick-windows:

- star the [project](https://github.com/joncloud/quick-windows)
- tweet your support for quick-windows
...
- **version**: (required) please note the version of quick-windows are you using
...
The original poster or the maintainers of quick-windows may close an issue at any time. Typically, but not exclusively, issues are closed when:
...
[so]: http://stackoverflow.com/questions/tagged/quick-windows
